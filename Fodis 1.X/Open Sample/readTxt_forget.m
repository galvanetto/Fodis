function [tracesExtend,tracesRetract] = readTxt_forget(file)

%Read JPK-force .txt  And forget!
...
columnsPossibleName={'vDeflection','tipSampleSeparation','verticalTipPosition','smoothedCapacitiveSensorHeight',...
    'capacitiveSensorHeight','measuredHeight','height','time'};
...
%% Generate Output
tracesExtend{1,1} = tempTipSampleSeparation';
tracesExtend{1,2}= tempVDeflaction';
