...
elseif strcmp(indexView,'Global contour length histogram') ||...
        ...
        strcmp(indexView,'Global contour length - Force plot')||...
...
if (strcmp(indexView,'Global delta Lc histograms'))
    ...
    if(strcmp(get(handles.menuLcDeltaLc, 'checked') , 'on'))
...
if (strcmp(indexView,'Global contour length - Force plot'))
    ...
    set(handles.buttonselectLcFc,'Enable','off');
    set(handles.buttondeleteLcFc,'Enable','off');
end
