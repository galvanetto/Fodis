...
positiveResult.indexTrace=sort(data.SelectTrace.Valid,'ascend');
...
if strcmp(choice,'Yes Please')
    data.translateLc(positiveResult.indexTrace)=-data.SelectTrace.lag(ref,positiveResult.indexTrace);
end
