...
% Last Modified by GUIDE v2.5 09-Jun-2017 12:07:22
...
clear -global temp
    ...
    txt = uicontrol('Parent',d,...
               'Style','text',...
               'Position',[20 80 360 100],...
               'String','There is a problem with the files or with the folder. Please check the User Guide or go to  https://github.com/nicolagalvanetto/Fodis/issues');
...
for iiName = 1:size(inputFileName, 2)
    ...
    txt = uicontrol('Parent',d,...
               'Style','text',...
               'Position',[20 80 360 100],...
               'String','The file you select is not in the correct format. Please check the User Guide or go to  https://github.com/nicolagalvanetto/Fodis/issues');
...
% hObject    handle to density_path (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to contributors (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
fingerprint_ROI;
% hObject    handle to finger_ROI (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
...
% hObject    handle to gethelp (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
