...
% Last Modified by GUIDE v2.5 26-Apr-2017 17:21:32
...
indexTrace = round(get(handles.sliderTraces, 'value'));    %Slider Position
indexeffTrace=positiveResult.indexTrace(indexTrace);       %Actual trace
...
%%
    case 'Global delta Lc histograms'
        ...
        elseif(strcmp(get(handles.menuLcDeltaLc, 'checked') , 'on'))
            set(handles.buttonSelectDeltaLc,'Enable','on');
            set(handles.buttonClearSelected,'Enable','on');
